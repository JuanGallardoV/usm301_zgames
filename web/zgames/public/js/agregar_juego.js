...
document.querySelector("#registrar-btn").addEventListener("click",async()=>{
    ...
    let consolaId = document.querySelector("#consola-selec").value;
    let fechaLanzamiento = document.querySelector("#fecha-txt").value;
    //El "+" es para convertirlo en numerico
    let precio = +document.querySelector("#precio-txt").value.trim();
    let aptoNinios = document.querySelector("#apto-si-rb").checked ? 1: 0;//Operador Ternario, es como el if
    let juego = {};
    juego.nombre = nombre;
